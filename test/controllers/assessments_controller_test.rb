...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference("Assessment.count") do
      post assessments_url, params: { assessment: { assessed_on: @assessment.assessed_on, assessee_id: @assessment.assessee_id, assessment_level_id: @assessment.assessment_level_id, assessor_id: @assessment.assessor_id } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { assessed_on: @assessment.assessed_on, assessee_id: @assessment.assessee_id, assessment_level_id: @assessment.assessment_level_id, assessor_id: @assessment.assessor_id } }
